...
export const bookingSchema = z
  .object({
    ...
    canceledAt: z
      .string()
      .datetime({ message: 'Data de cancelamento inválida' })
      .nullable()
      .optional(),
    confirmedAt: z
      .string()
      .datetime({ message: 'Data de confirmação inválida' })
      .nullable()
      .optional(),
    ...
    professional: z.object({
      ...
      user: z.object({
        ...
        name: z.string().min(2, {
          message: 'Nome do profissional deve ter pelo menos 2 caracteres',
        }),
      }),
    }),
    user: z.object({
...
export const createBookingBodySchema = z
  .object({
    ...
    startDateTime: z.string().datetime({
      offset: true,
      message: 'Data/hora de início inválida. Use formato ISO com timezone',
    }),
    notes: z
      .string()
      .max(500, { message: 'Observações não podem exceder 500 caracteres' })
...
// Tipos derivados
export type GetOrUpdateBookingStatusParams = z.infer<typeof getOrUpdateBookingStatusParamsSchema>;
