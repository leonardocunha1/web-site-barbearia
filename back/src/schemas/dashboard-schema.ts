...
export const metricsSchema = z.object({
  appointments: z.number()
    ...
    .nonnegative({ message: 'O número de agendamentos não pode ser negativo' })
  ...
  canceled: z.number()
    ...
    .nonnegative({ message: 'O número de cancelamentos não pode ser negativo' })
...
export const nextAppointmentSchema = z.object({
  id: z.string()
    .uuid({ message: 'ID do agendamento inválido' })
    .describe('ID do agendamento'),
  date: z.string()
...
export const dashboardSchema = z.object({
  ...
  nextAppointments: z.array(nextAppointmentSchema)
    .max(10, { message: 'A lista de próximos agendamentos está limitada a 10 itens' })
