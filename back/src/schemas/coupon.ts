...
export const couponSortFieldSchema = z
  ...
  .describe('CouponSortField');

/**
 * Ordem válida para ordenação.
 */
export const couponSortOrderSchema = z.enum(['asc', 'desc']).describe('CouponSortOrder');
...
export const paginatedCouponResponseSchema = z
  ...
  .describe('PaginatedCouponResponse');
