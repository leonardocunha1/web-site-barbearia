...
export const professionalSchema = z
  .object({
    ...
    ativo: z.coerce.boolean().describe("Indica se o profissional está ativo"),
...
export const createProfessionalBodySchema = z
  .object({
    ...
    registro: z.string().optional().describe("Número de registro profissional"),
...
export const dashboardQuerySchema = z
  ...
  .refine(
    ...
    {
      message:
        "Ambas as datas (início e término) são obrigatórias para período customizado",
...
>;
export type ListProfessionalsQuery = z.infer<
  typeof listProfessionalsQuerySchema
>;
export type ToggleProfessionalStatusParams = z.infer<
  typeof toggleProfessionalStatusParamsSchema
>;
export type UpdateProfessionalParams = z.infer<
  typeof updateProfessionalParamsSchema
>;
export type UpdateProfessionalBody = z.infer<
  typeof updateProfessionalBodySchema
>;
export type CreateProfessionalBody = z.infer<
