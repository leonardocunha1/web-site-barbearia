...
export const zodcreateCouponBody = zod.object({
  ...
  "expirationType": zod.enum(['DATE', 'QUANTITY', 'BOTH']),
...
export const zodlistCouponsResponse = zod.object({
  ...
  "startDate": zod.string().datetime({}).or(zod.any()),
  "endDate": zod.string().datetime({}).or(zod.any()).nullable(),
  "minBookingValue": zod.number().min(zodlistCouponsResponseCouponsItemMinBookingValueMin).nullable(),
  "active": zod.boolean(),
  "createdAt": zod.string().datetime({}).or(zod.any()),
  "updatedAt": zod.string().datetime({}).or(zod.any()),
  "service": zod.object({
  "id": zod.string().uuid(),
  "name": zod.string()
}).nullish(),
...
export const zodupdateCouponBody = zod.object({
  ...
  "scope": zod.enum(['GLOBAL', 'SERVICE', 'PROFESSIONAL']).optional(),
  "expirationType": zod.enum(['DATE', 'QUANTITY', 'BOTH']).optional(),
